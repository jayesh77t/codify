  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className={`group relative flex items-center gap-3 px-4 py-2.5 bg-gray-200/80 dark:bg-[#1e1e2e]/80 
      rounded-lg transition-all 
       duration-200 border border-gray-300/50 dark:border-gray-800/50 hover:border-gray-400 dark:hover:border-gray-700
      ...
      >
        ...
        <div className="size-6 rounded-md bg-gray-300/80 dark:bg-gray-800/50 p-0.5 group-hover:scale-110 transition-transform">
          <Image
        ...
        <span className="text-gray-700 dark:text-gray-200 min-w-[80px] text-left group-hover:text-gray-900 dark:group-hover:text-white transition-colors">
          {currentLanguageObj.label}
        </span>

        <ChevronDownIcon
          className={`size-4 text-gray-500 dark:text-gray-400 transition-all duration-300 group-hover:text-gray-700 dark:group-hover:text-gray-300
            ${isOpen ? "rotate-180" : ""}`}
        />
      </motion.button>
