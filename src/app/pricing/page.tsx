...
async function PricingPage() {
  ...
  return (
    <div
      className="relative min-h-screen bg-gray-100 dark:bg-[#0a0a0f] selection:bg-blue-500/20
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-24">
            <div className="relative inline-block">
              ...
              <h1
               ...
               from-gray-800 to-gray-600 dark:from-gray-100 dark:to-gray-300 text-transparent bg-clip-text mb-8"
              >
                Elevate Your <br />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
            {ENTERPRISE_FEATURES.map((feature) => (
              <div
                key={feature.label}
                className="group relative bg-gradient-to-b from-white to-gray-50 dark:from-[#12121a] dark:to-[#0a0a0f] rounded-2xl p-6 hover:transform hover:scale-[1.02] transition-all duration-300 border border-gray-200 dark:border-transparent"
              >
                <div className="relative">
                  <div
                    className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 
                  flex items-center justify-center mb-4 ring-1 ring-gray-300 dark:ring-gray-800/60 group-hover:ring-blue-500/20"
                  >
                    <feature.icon className="w-6 h-6 text-blue-500 dark:text-blue-400" />
                  </div>

                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">{feature.label}</h3>
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            />
            <div className="relative bg-white dark:bg-[#12121a]/90 backdrop-blur-xl rounded-2xl border border-gray-200 dark:border-transparent">
              <div
              ...
              <div className="relative p-8 md:p-12">
                ...
                <div className="text-center mb-12">
                  <div className="inline-flex p-3 rounded-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 ring-1 ring-gray-300 dark:ring-gray-800/60 mb-6">
                    <Star className="w-8 h-8 text-blue-500 dark:text-blue-400" />
                  </div>
                  <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-4">Lifetime Pro Access</h2>
                  <div className="flex items-baseline justify-center gap-2 mb-4">
                    <span className="text-2xl text-gray-600 dark:text-gray-400">₹</span>
                    <span className="text-6xl font-semibold bg-gradient-to-r from-gray-800 to-gray-600 dark:from-gray-100 dark:to-gray-300 text-transparent bg-clip-text">
                      49
                    </span>
                    <span className="text-xl text-gray-600 dark:text-gray-400">one-time</span>
                  </div>
                  <p className="text-gray-600 dark:text-gray-400 text-lg">Unlock the full potential of CodeCraft</p>
                </div>
